            ...
            <div class="row">
                <div class="col-xl-6 offset-xl-3">
                    <div class="subscribe-content text-center">
                        ...
                        <p>Subscribing to our newsletter allows you access in to what we do and our corporate
                            activities.</p>
                        <form action="{{ route('subscribers.store') }}" method="POST" class="d-flex align-items-center">
                            @csrf
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="footer-link-widget wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <h4 class="widget-title">Mousumi Outfitters</h4>
                        <ul class="contact-infor">
                            <li>
                                <img src="{{ asset('frontend/assets/imgs/theme/icons/icon-location.svg') }}" alt="" /><strong>Address: </strong>
                                <span>{{ get_setting('business_address')->value ?? 'null' }}</span>
                            </li>
                            
                            <li>
                                <img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg') }}" alt="" /><strong>Call Us: </strong><a
                                    href="tel:{{ get_setting('phone')->value ?? 'null' }}">{{ get_setting('phone')->value ?? 'null' }}</a>
                            </li>
                            
                            <li>
                                <img src="{{ asset('frontend/assets/imgs/theme/icons/icon-email-2.svg') }}" alt="" /><strong>Email: </strong><a
                                    href="mailto:{{ get_setting('email')->value ?? 'null' }}">{{ get_setting('email')->value ?? 'null' }}</a>
                            </li>
                            
                            <li>
                                <img src="{{ asset('frontend/assets/imgs/theme/icons/icon-clock.svg') }}" alt="" /><strong>Hours:</strong><span>
