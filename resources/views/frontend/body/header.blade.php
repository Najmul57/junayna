<header class="header-area header-style-1 header-height-2">
    ...
    <div class="container-fluid d-none d-lg-block header-menu header-sticky">
        <div class="row align-items-center">
            ...
            <div class="col-lg-2">
                <ul class="all__categories">
                    <li> <span><i class="fa fa-bars"></i> all categories</span>
                        <ul class="category">
                            <li><a href="">home</a>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    ...
                                    @if($sub_category->sub_sub_categories && count($sub_category->sub_sub_categories) >
                                    0)
            ...
            <div class="col-lg-2">
                <div class="header-right">
                    <ul class="d-flex justify-content-end">
                        <li data-bs-toggle="offcanvas" href="#search_offcanvas" role="button"
                        ...
                        <div class="search-product-content">
                            ...
                            <div class="product-size d-flex mt-2 mb-1">
                                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                    <input type="radio" class="btn-check" name="btnradio" id="SS" autocomplete="off"
                                        checked>
                                    <label class="btn" for="SS">S</label>

                                    <input type="radio" class="btn-check" name="btnradio" id="SM" autocomplete="off">
                                    <label class="btn" for="SM">M</label>

                                    <input type="radio" class="btn-check" name="btnradio" id="SL" autocomplete="off">
                                    <label class="btn" for="SL">L</label>

                                    <input type="radio" class="btn-check" name="btnradio" id="SXL" autocomplete="off">
                                    <label class="btn" for="SXL">XL</label>

                                    <input type="radio" class="btn-check" name="btnradio" id="SXXL" autocomplete="off">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="shopping_offcanvas" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="search_offcanvas" aria-labelledby="offcanvasExampleLabel">
        <div class="offcanvas-header border-bottom">
        ...
        <form action="{{ route('product.search')}}" method="post" class=" search-system">
            @csrf
            <select class="form-select" name="searchCategory" id="searchCategory" aria-label="Default select example">
    ...
    <div class="mobile-header-wrapper-inner">
        ...
        <div class="mobile-header-content-area">
                            ...
                            <ul class="dropdown">
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        @endforeach
                                        @if($subcategory->sub_sub_categories && count($subcategory->sub_sub_categories)
                                        > 0)
                                        <ul class="dropdown">
            ...
            <div class="mobile-header-info-wrap">
                ...
                <div class="single-mobile-header-info">
                    <a href="tel:{{ get_setting('phone')->value ?? 'null' }}"><i class="fi-rs-headphones"></i>{{
            ...
            <div class="site-copyright">
                Developed by:
                <a target="_blank" href="{{ get_setting('developer_link')->value ?? 'null' }}">{{
                    get_setting('developed_by')->value ?? 'null' }}</a>
            </div>
        </div>
    </div>
</div>
