		        	...
		        	<div class="card-body">
		        		<div class="row">
	                        ...
	                        <div class="col-md-6 mb-4">
	                            ...
	                            <textarea name="short_description_en" rows="2" cols="2" class="form-control" placeholder="Write Short Description English">{{old('short_description_en')}}</textarea>
	                        </div>
	                        <div class="col-md-6 mb-4">
	                          	<label for="short_descp_bn" class="col-form-label" style="font-weight: bold;">Description (Bn):</label>
	                            <textarea name="short_description_bn" id="short_descp_bn" rows="2" cols="2" class="form-control" placeholder="Write Short Description Bangla">{{old('short_description_bn')}}</textarea> 
	                        </div>
